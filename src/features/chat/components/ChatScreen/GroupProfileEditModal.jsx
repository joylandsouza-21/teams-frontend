...
export default function GroupProfileEditModal({ onClose, groupPhoto, activeChat }) {
  ...
  useEffect(() => {
    if (groupPhoto) {
      setPreview(`${import.meta.env.VITE_API_BASE_URL}${groupPhoto}`);
      setGroupFile(null);
    }
  }, [groupPhoto]);
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between mb-5">
          <h2 className="text-lg font-semibold">Group picture</h2>
